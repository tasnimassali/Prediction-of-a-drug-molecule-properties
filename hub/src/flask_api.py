...
from hub.src.main import Predict
...
def predict_from_file(path_X_test):
    ...
    # Example: 
    # path_X_test=hub/data/dataset_single_test.csv
    # Link: 
    #     http://10.188.219.126:8000/predict_from_file/hub/data/dataset_single_test.csv
    # OR :
    #     http://10.188.219.126:8000/predict_from_file/hub/data/dataset_single.csv 
...
#     y_pred =Predict(X_test, model_type = 'model1')
